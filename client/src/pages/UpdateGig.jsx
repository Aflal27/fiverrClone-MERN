...
export default function UpdategGig() {
  ...
  useEffect(() => {
    const fetchSingleGigData = async () => {
      try {
        const { data } = await axios.get(
          `/api/gig/getsinglegig/${currentUser._id}/${gigId}`
        );
        setGigData(data);
      } catch (error) {
        console.log("fetchSingleGigData", error);
      }
    };
    fetchSingleGigData();
  }, [gigId]);
  const handleUpdateImage = () => {
    if (gigData?.images) {
      gigData.images.map((image) => {
        setFormdata({ ...formdata, images: formdata.images.concat(image) });
      });
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `/api/gig/updategig/${currentUser._id}/${gigData._id}`,
        formdata
      );
      console.log(data);
        ...
        {navigateBtn === 1 && (
          <form className="flex flex-col gap-5 mt-4">
            <div className=" flex flex-col gap-4 ">
              ...
              />
              <Textarea
                defaultValue={gigData?.descriptiion}
                required
              ...
              <Select
                ...
                <option value="uncategorized">
                  {gigData?.category ? gigData?.category : "Select a category"}
                </option>
                ...
                <Table.Body className=" ">
                  <Table.Row>
                    <Table.Cell>
                      <TextInput
                        className=" w-full"
                        defaultValue={gigData.base.baseTitle}
                    ...
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.silver.silverTitle}
                        className=" w-full"
                    ...
                    <Table.Cell>
                      <TextInput
                        className=" w-full"
                        defaultValue={gigData.platinum.platinumTitle}
                  ...
                  <Table.Row>
                    <Table.Cell>
                      <Textarea
                        defaultValue={gigData.base.baseDescription}
                        required
                        placeholder="description"
                        onChange={(e) =>
                          setFormdata({
                    ...
                    <Table.Cell>
                      <Textarea
                        defaultValue={gigData.silver.silverDescription}
                        required
                        placeholder="description"
                        onChange={(e) =>
                          setFormdata({
                    ...
                    <Table.Cell>
                      <Textarea
                        defaultValue={gigData.platinum.platinumDescription}
                        required
                        placeholder="description"
                        onChange={(e) =>
                          setFormdata({
                  ...
                  <Table.Row>
                    <Table.Cell>
                      <div className=" flex items-center gap-1">
                        <span>$</span>
                        <TextInput
                          defaultValue={gigData.base.basePrice}
                          className=" w-full"
                          placeholder="price"
                          type="number"
                          required
                    ...
                    <Table.Cell>
                      <div className=" flex items-center gap-1">
                        <span>$</span>
                        <TextInput
                          defaultValue={gigData.silver.silverPrice}
                          className=" w-full"
                          placeholder="price"
                          type="number"
                          required
                    ...
                    <Table.Cell>
                      <div className=" flex items-center gap-1">
                        <span>$</span>
                        <TextInput
                          defaultValue={gigData.platinum.platinumPrice}
                          className=" w-full"
                          placeholder="price"
                          type="number"
                          required
                  ...
                  <Table.Row>
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.base.baseRevision}
                        className=" w-full"
                    ...
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.silver.silverRevision}
                        className=" w-full"
                        placeholder="revisions"
                        type="number"
                        required
                    ...
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.platinum.platinumRevision}
                        className=" w-full"
                        placeholder="revisions"
                        type="number"
                        required
                  ...
                  <Table.Row>
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.base.baseDays}
                        className=" w-full"
                    ...
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.silver.silverDays}
                        className=" w-full"
                        placeholder="delivery"
                        type="number"
                        required
                    ...
                    <Table.Cell>
                      <TextInput
                        defaultValue={gigData.platinum.platinumDays}
                        className=" w-full"
                        placeholder="delivery"
                        type="number"
                        required
